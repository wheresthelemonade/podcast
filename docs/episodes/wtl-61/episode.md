...
<div>
{% include_relative _includes/_includes/transistor.html id="413c4c61" title="#61 #6.1 We're back and we are not stuck in a rut, or are we?" %}

{% include_relative _includes/_includes/youtube.html id="tu856ZK_XFM" %}
</div>
